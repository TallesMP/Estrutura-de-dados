...
void teste_ver_elemento(void) {
  ...
  priority_enqueue(queue, &data1, 3);
  priority_enqueue(queue, &data2, 2);
  priority_enqueue(queue, &data3, 1);

#ifdef debug
  int *elemento;
  queue_status status = ver_elemento(queue, 0, (elementoT *)&elemento);
  ...
  status = ver_elemento(queue, 1, (elementoT *)&elemento);
  ...
  status = ver_elemento(queue, 2, (elementoT *)&elemento);
  ...
  status = ver_elemento(queue, 4, (elementoT *)&elemento);
  printf("Acesso a posição 4: %s\n",
